(function ($, window, document, undefined) {
  ...
  $.extend(Plugin.prototype, {
      ...
      if (marqueed_el.hovered == false) {
        if (marqueed_el.counter > 0) {
          ...
          marqueed_el.distanceLeft =
            marqueed_el.totalDistance - (marqueed_el.containerWidth - plugin.getPosition(elName));
        } else {
        ...
        marqueed_el.distanceLeft =
          marqueed_el.totalDistance - (marqueed_el.containerWidth - plugin.getPosition(elName));
        marqueed_el.timeLeft =
          ((marqueed_el.totalDistance - (marqueed_el.containerWidth - marqueed_el.currentPos)) /
            marqueed_el.totalDistance) *
          marqueed_el.duration;
      }
    ...
    marqueeAnim: function (marqueeObject) {
      ...
      marqueeObject.el
        .clearQueue()
        .animate({ left: marqueeObject.endPoint + "px" }, marqueeObject.timeLeft, "linear", function () {
