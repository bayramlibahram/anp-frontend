!(function (e) {
  ...
  function (e, t, r) {
        ...
        (function (e) {
          for (
            ...
            (o.match(/^(https?:)?\/\/[^\/]+\/api\/iframe\?.+/) ||
              o.match(/^(https?:)?\/\/[^\/]+\/\w+(\?.*)?$/)) &&
              n.postMessage({ method: "getSize" }, "*", a.contentWindow);
          }
    ...
    var a = (t.getIframeWrapper = function (e, t) {
      ...
      if (
        ...
        if (
          ...
          return { aspectWrapper: r, maxWidthWrapper: n };
      }
    });
    (t.addDefaultWrappers = function (e) {
      ...
      return (
        ...
        r.appendChild(n),
        t.insertBefore(r, e),
        { aspectWrapper: n, maxWidthWrapper: r }
      );
    }),
  ...
  function (e, t, r) {
    ...
    (i.VERSION = 1),
      ...
      (i.BASE_RE = /^(?:https?:)?\/\/[^\/]+/i),
      (i.ID_RE = /^(?:https?:)?\/\/[^\/]+\/(\w+)(?:\?.*)?$/),
      (i.SCRIPT_RE = /^(?:https?:|file:\/)?\/\/[^\/]+(?:.+)?\/(?:embed|iframely)\.js(?:[^\/]+)?$/i),
      (i.CDN_RE = /^(?:https?:)?\/\/([^\/]+)\/(?:embed|iframely)\.js(?:[^\/]+)?$/i),
  ...
  function (e, t, r) {
    ...
    function o(e, t, r) {
      ...
      if (o)
        (a = i.getWidget(t)),
          n.cancelWidget(
            a || { maxWidthWrapper: t, iframe: t, url: t.getAttribute("href") }
          );
      else {
        var u, p;
        if (
          ...
          u.insertBefore(a, p),
            (function e(t) {
              ...
              for (a = 0; s[a]; a++)
                "script",
                  !(o = n = s[a]).nodeName ||
                  o.nodeName.toUpperCase() !== "script".toUpperCase() ||
                  (n.type &&
                    "text/javascript" !== n.type.toLowerCase() &&
                    "application/javascript" !== n.type.toLowerCase())
                    ? e(n)
                    : (d.push(n), t.removeChild(n));
              for (a = 0; d[a]; a++)
                (i = d[a]).parentNode && i.parentNode.removeChild(i), r(d[a]);
            })(a);
        u.removeChild(p),
          c &&
            setTimeout(function () {
            ...
            function l(e) {
                ...
                (l.CDN = f && f[0]),
                  s
                    ? JSON.stringify(l, Object.keys(l).sort()) !==
                        JSON.stringify(s, Object.keys(s).sort()) && (p = !0)
                    : (s = l);
              }
              if (p) n.trigger("load", e);
                ...
                u || (u = e.getAttribute("href")),
                  (s.key || s.api_key || n.config.api_key || n.config.key) && u
        ...
        e &&
          ...
          (function (e) {
            if (e.getAttribute("data-iframely-url") || e.getAttribute("href")) {
              ...
              if (
                (r && /^((?:https?:)?\/\/[^\/]+)\/\w+/i.test(r)
                  ? (t = i.getEndpoint(r, { v: n.VERSION, app: 1 }))
                  : (n.config.api_key || n.config.key) && n.CDN
                  ? (t = i.getEndpoint(
                      "/api/iframe",
                      { url: e.getAttribute("href"), v: n.VERSION, app: 1 },
                      n.SUPPORTED_QUERY_STRING
                    ))
                  : console.warn(
                ...
                if (s)
                  for (; s.aspectWrapper.lastChild; )
                    s.aspectWrapper.removeChild(s.aspectWrapper.lastChild);
                else (s = i.addDefaultWrappers(e)), e.parentNode.removeChild(e);
                s.aspectWrapper.appendChild(a),
                  o
  ...
  function (e, t, r) {
    ...
    n.on("load", function (e) {
      if (
        ...
        !(function (e, t) {
          var r,
            a = i.parseQueryString(t),
            o = {};
          for (var d in a) 0 === d.indexOf("_") && (o[d] = a[d]);
          if (t.match(/\/api\/iframe/))
            r = i.getEndpoint(
              t.match(/^(.+)\/api\/iframe/i)[1] + "/api/thumbnail",
              Object.assign({ url: a.url, api_key: a.api_key, key: a.key }, o)
            );
          else {
            if (!t.match(/^(?:https?:)?\/\/[^\/]+\/[a-zA-Z0-9]+(?:\?.*)?$/))
              return;
            r = i.getEndpoint(
              t.replace(
                /^((?:https?:)?\/\/[^\/]+\/[a-zA-Z0-9]+)((\?.*)?)$/,
          ...
          if (p && parseInt(p[1]) && u) {
            ...
            i.setStyles(f, {
              ...
              f.appendChild(s),
              e.aspectWrapper.appendChild(f);
          } else e.aspectWrapper.appendChild(s);
        })(t, r),
          (r = i.addQueryString(r, { img: 1 })),
          e.setAttribute("data-iframely-url", r),
          new c(t),
          n.trigger("load", e);
      }
    }),
      n.on("message", function (e, t) {
        var r;
        "widgetRendered" === t.method && (a(e), (r = s(e)) && r.deactivate()),
  ...
  function (e, t, r) {
    ...
    n.on("message", function (e, t) {
      if (
        ...
        !a && t.height && (a = { height: t.height, "max-width": "keep" }),
          (function (e, t) {
